<div align="center">
  ...
  <p align="center">
    <b>🌱 念念不忘，必有回响 | 探索计算机底层系统、科学计算建模与 AI Agentic 生产力</b>
  </p>
...
- 🎬 **科技内容自动化**：主导开源 **[VideoAgent](https://github.com/ciyuan1234/VideoAgent)**，基于 Apple Silicon 硬件加速打造零摩擦端到端科技视频生产引擎。
- 📖 **CS 408 核心研习**：深度攻坚操作系统内核模型、高并发网络 I/O 多路复用、CPU 缓存架构与算法优化。
- 📊 **数学建模与数值计算**：专注于全国大学生数学建模（CUMCM）与美赛（MCM），深耕有限体积法 (FVM)、热质传递非线性 PDE 求解、数据契约规范与论文复现。
- ⚡ **效率与 Agent 极客**：重度终端与自动化开发者，探索基于 Agentic Workflow 与 LLM 原生架构的生产力跃迁。

---

### 🌟 旗舰开源项目 / Flagship Project
  ...
  <table>
    <tr>
      <td width="100%">
        ...
        <p align="center">
          <b>面向 Apple Silicon 与硬核技术博主的 AI-Native 视频生成管线。</b><br/>
          只需输入任意技术主题、本地 Markdown、源码或博文链接，全自动完成 AST 语法知识萃取、4 大叙事节拍编排、5 维质量门禁评分，一键交付带 Silicon 语法高亮代码卡片、Mermaid 原生架构图与 32kHz 录音棚级语音的 1080P/60FPS 科技风成片！
        </p>
      </td>
    </tr>
  </table>
...
### 📌 精选开源沉淀 / Featured Repositories

<table>
  <tr>
    <td width="50%" valign="top">
      <h3 align="center"><a href="https://github.com/ciyuan1234/MCM_skills">🤖 MCM_skills</a></h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Language-Python-3776AB?style=flat-square" alt="Python"/>
        <img src="https://img.shields.io/badge/Type-AI_Agent_Skills-blueviolet?style=flat-square" alt="Skills"/>
      </p>
      <p><b>CUMCM 国赛 AI Skill 工作流包</b>：从读题解析、数据契约、机理/PDE 建模推导到网格收敛性验证及论文全自动交付。无缝适配 Claude Code、Codex、Antigravity 等主流 Agent 终端。</p>
    </td>
    <td width="50%" valign="top">
      <h3 align="center"><a href="https://github.com/ciyuan1234/MCM_2026">📊 MCM_2026</a></h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Language-Python-3776AB?style=flat-square" alt="Python"/>
        <img src="https://img.shields.io/badge/Topic-Mathematical_Modeling-orange?style=flat-square" alt="Modeling"/>
      </p>
      <p><b>数模竞赛全栈开源沉淀库</b>：覆盖全国大学生数学建模与美赛的求解全流程，包含学术论文草稿、机理数值仿真代码、结果数据契约与出版级高分辨率学术图表生成流。</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <h3 align="center"><a href="https://github.com/ciyuan1234/408">📚 408</a></h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Language-TypeScript%20%2F%20C-3178C6?style=flat-square" alt="TypeScript"/>
        <img src="https://img.shields.io/badge/Topic-CS_Examination-success?style=flat-square" alt="CS408"/>
      </p>
      <p><b>计算机 408 考研高能演练空间</b>：聚焦数据结构手撕算法、操作系统内核原语、计算机网络协议栈与计组硬件流水线，整理高频易错考点、真题归纳与深度复盘笔记。</p>
    </td>
    <td width="50%" valign="top">
      <h3 align="center"><a href="https://github.com/ciyuan1234/Kite-Blog">🚀 Kite-Blog</a></h3>
      <p align="center">
        <img src="https://img.shields.io/badge/Framework-Astro-BC52EE?style=flat-square" alt="Astro"/>
        <img src="https://img.shields.io/badge/Type-Personal_Blog-informational?style=flat-square" alt="Blog"/>
      </p>
      <p><b>Kite 的个人现代化极客博客</b>：基于 Astro 极速现代框架与 TailwindCSS 构建，沉淀计算机底层原理研习、数学建模算法推导实录与全栈工程技术思考。</p>
    </td>
  </tr>
</table>
...
| **系统、多媒体与工具** | ![macOS](https://img.shields.io/badge/Apple_Silicon-000000?style=flat-square&logo=apple&logoColor=white) ![Git](https://img.shields.io/badge/Git-F05032?style=flat-square&logo=git&logoColor=white) ![GitHub](https://img.shields.io/badge/GitHub-181717?style=flat-square&logo=github&logoColor=white) ![FFmpeg](https://img.shields.io/badge/FFmpeg-007808?style=flat-square&logo=ffmpeg&logoColor=white) ![VS Code](https://img.shields.io/badge/VS_Code-007ACC?style=flat-square&logo=visual-studio-code&logoColor=white) |
...
<div align="center">
  ...
  <img src="https://github-profile-trophy.vercel.app/?username=ciyuan1234&theme=tokyonight&no-frame=true&no-bg=true&margin-w=4" alt="GitHub Trophies" />
